...
ani0.from('#title img', { autoAlpha: 0, yPercent: 100, xPercent: -100, duration: 1.0 }, 'text')
...
ani1.from('#sec1 h1', { autoAlpha: 0, yPercent: -100, duration: 0.5 })
    .from('#sec1 .text-wrap', { autoAlpha: 0, yPercent: -100, delay: 0.5 })
ScrollTrigger.create({
    animation: ani1,
    trigger: '#sec1',
    toggleActions: 'play pause none',
...
ani4.from('#sec4 h1', { autoAlpha: 0, yPercent: -100, duration: 0.5 }, 'text')
    .from('#sec4 ul li', { autoAlpha: 0, duration: 0.5, delay: 1.0 }, 'text')
ScrollTrigger.create({
    animation: ani4,
    trigger: '#sec4',
    toggleActions: 'play pause none',
...
ani6.from('#sec6 img', { autoAlpha: 0, delay: 0.5 }, 'text')
ScrollTrigger.create({
    animation: ani6,
    trigger: '#sec6',
    toggleActions: 'play pause none',
...
ani13.from('#sec13 h1', { autoAlpha: 0, yPercent: -100, duration: 0.5 }, 'text')
    .from('#sec13 img', { autoAlpha: 0, xPercent: 100, delay: 0.5 }, 'text')
ScrollTrigger.create({
    animation: ani13,
    trigger: '#sec13',
    toggleActions: 'play pause none',
...
ani14.from('#sec14 h1', { autoAlpha: 0, yPercent: -100, duration: 0.5 }, 'text')
    .from('#sec14 li', { autoAlpha: 0, yPercent: 100, delay: 0.5, stagger: 0.5 }, 'text')
ScrollTrigger.create({
    animation: ani14,
    trigger: '#sec14',
    toggleActions: 'play pause none',
...
ani15.from('#sec15 h1', { autoAlpha: 0, yPercent: -100, duration: 0.5 }, 'text')
    .from('#sec15 img', { autoAlpha: 0, yPercent: -100, duration: 0.5, delay: 0.5 }, 'text')
