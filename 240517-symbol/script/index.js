...
ani2.from('#sec2 h2', { autoAlpha: 0, yPercent: -100, duration: 0.5 }, 'text')
    ...
    .from('#sec2 ul', { autoAlpha: 0, duration: 0.5, delay: 1.0 }, 'text')
ScrollTrigger.create({
    animation: ani2,
    trigger: '#sec2',
    toggleActions: 'play pause none',
...
ani3.from('#sec3 h2', { autoAlpha: 0, yPercent: -100, duration: 1.0 }, 'text')
    .from('#sec3 li', { autoAlpha: 0, yPercent: -100, duration: 1.0, delay: 0.5 }, 'text')
ScrollTrigger.create({
    animation: ani3,
    trigger: '#sec3',
    toggleActions: 'play pause none',
...
ani7.from('#sec7 h2', { autoAlpha: 0, yPercent: -100, duration: 0.5 }, 'text')
    .from('#sec7 p', { autoAlpha: 0, yPercent: -100, duration: 0.5 }, 'text')
    .from('#sec7 img', { autoAlpha: 0, duration: 0.5, delay: 0.5 }, 'text')
ScrollTrigger.create({
    animation: ani7,
    trigger: '#sec7',
    toggleActions: 'play pause none',
